...
- CI commands: dotnet test .\FoToolbox.sln -c Release --no-build --collect:"XPlat Code Coverage"
...
## Task Focus
- Backlog counts: todo 6, in_progress 0, blocked 0, done 0
